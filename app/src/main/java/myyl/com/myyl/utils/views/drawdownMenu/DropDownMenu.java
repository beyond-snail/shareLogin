package myyl.com.myyl.utils.views.drawdownMenu;
...
public class DropDownMenu extends LinearLayout {
    ...
    private int menuDownItem = 0;

    private int tabCount = 0;
    private PopNoListener listener;
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        menuDownItem = a.getInteger(R.styleable.DropDownMenu_ddmenuMenuDown,menuDownItem);
        a.recycle();
     ...
     * @param contentView
     */
    public void setDropDownMenu(@NonNull List<String> tabTexts, List<View> popupViews, @NonNull View contentView, PopNoListener popNoListener) {
//        if (tabTexts.size() != popupViews.size()) {
//            throw new IllegalArgumentException("params not match, tabTexts.size() should be equal popupViews.size()");
//        }

        tabCount = tabTexts.size();
        listener = popNoListener;
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        if (i==0) {
            ...
            tab.setBackgroundResource(R.drawable.background_with_bottom);
        }
...
//        }
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            ((TextView) tabMenuView.getChildAt(current_tab_position)).setBackgroundResource(R.drawable.background_with_bottom);
            if (current_tab_position > tabCount-menuDownItem-1) {
        ...
        for (int i = 0; i < tabMenuView.getChildCount(); i++) {
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    ((TextView) tabMenuView.getChildAt(i)).setBackgroundResource(R.drawable.background_with_bottom);
                    if (i > tabCount-menuDownItem-1) {
                        ...
                        //没有pop的时候回调
                        if(listener!=null){
                            listener.noPopCallback(current_tab_position);
                        }
                    }
                }
            } else {
                ((TextView) tabMenuView.getChildAt(i)).setTextColor(textUnselectedColor);
                ((TextView) tabMenuView.getChildAt(i)).setBackgroundResource(R.drawable.background_with_bottom1);
                if (i > tabCount-menuDownItem-1) {
                    ((TextView) tabMenuView.getChildAt(i)).setCompoundDrawablesWithIntrinsicBounds(null, null,
                            getResources().getDrawable(menuUnselectedIcon), null);
                }
