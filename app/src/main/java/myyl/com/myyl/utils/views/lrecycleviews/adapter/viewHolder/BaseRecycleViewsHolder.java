...
package myyl.com.myyl.utils.views.lrecycleviews.adapter.viewHolder;
...
public class BaseRecycleViewsHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
    /**
    ...
    public BaseRecycleViewsHolder(View view, final IRcyclerClickBack mCallBack) {
        super(view);//必须实现
        this.mView = view;
     ...
     * 专门处理多布局的构造方法
     */
    public BaseRecycleViewsHolder(View view, IRcyclerClickBack mCallBack, int itemType) {
        this(view, mCallBack);
     ...
     * @return ：
     */
    public BaseRecycleViewsHolder setClickListener(@IdRes int viewId) {
     ...
     * @return ：
     */
    public BaseRecycleViewsHolder setLongClickListener(@IdRes int viewId) {
        View view = getView(viewId);
        if (view != null) {
     ...
     * @return ：
     */
    public BaseRecycleViewsHolder setItemClickListener() {
        if (mView != null) {
            mView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mCallBack.onItemClickBack(mPosition, v, BaseRecycleViewsHolder.this);
                }
            });
        }
        return this;
     ...
     * @return ：
     */
    public BaseRecycleViewsHolder setItemLongClickListener() {
        if (mView != null) {
            mView.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
                    mCallBack.onLongItemClickBack(mPosition, v, BaseRecycleViewsHolder.this);
                    return true;
                }
            });
        }
