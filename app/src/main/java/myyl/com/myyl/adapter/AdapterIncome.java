...
public class AdapterIncome extends BaseAdapter {
    ...
    private List<IncomeItemInfo> list;


    public AdapterIncome(Context context, List<IncomeItemInfo> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_income, parent, false);
        ...
        IncomeItemInfo vo = list.get(position);
