...
public class AdapterPj extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<MyPjInfo> list;

    private AudioRecorderButton mAudioRecorderButton;
    private View mAnimView;

    public AdapterPj(Context context, List<MyPjInfo> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_pj, parent, false);
