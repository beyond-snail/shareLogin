...
public class AdapterClinical extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<MyClinicalInfo> list;


    public AdapterClinical(Context context, List<MyClinicalInfo> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MyClinicalInfo vo = list.get(position);
