...
public class AdapterFmMoreList extends BaseAdapter {
    ...
    public AdapterFmMoreList(Context context, List<MyFmInfo> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_fm_list, parent, false);
